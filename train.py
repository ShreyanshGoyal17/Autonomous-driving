...
if __name__ == '__main__':
    ...
    for i_episode in range(200000):
        ...
        while True:
            ...
            if done:
                ...
                if best_reward <= total_reward:
                    ...
                    dqn.save("./trained_models/" + str(round(best_reward)) + ".tar")
                if i_episode % 1000 == 999:
                    dqn.save("./trained_models/" + str(i_episode) + ".tar")
        ...
        dqn.writer.add_scalar('Episodic Rewards', total_reward, i_episode)